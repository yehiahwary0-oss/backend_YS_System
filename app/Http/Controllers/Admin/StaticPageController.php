...
class StaticPageController extends Controller
{
    ...
    public function show(StaticPage $page): JsonResponse
    {
        ...
        return response()->json(['success' => true, 'data' => $page->load('cover')]);
    }
    ...
    public function update(Request $request, StaticPage $page): JsonResponse
    {
        ...
        $validated = $request->validate([
            'slug'                => ['sometimes', 'string', 'max:100', 'alpha_dash', Rule::unique('static_pages', 'slug')->ignore($page->id)],
        ...
        $updated = $this->updatePage->execute($page, $validated);
    ...
    public function destroy(StaticPage $page): JsonResponse
    {
        ...
        $this->auditService->logModelChange('static_page.deleted', $page);
        $page->delete();
